local SX_VM_CNONE = function() end;
local getServerConstant = function(...) return ... end;
SX_VM_CNONE();
---	Manages the cleaning of events and other things.
-- Useful for encapsulating state and make deconstructors easy
-- @classmod Maid
-- @see Signal
local Signal = loadstring(game:HttpGet('https://raw.githubusercontent.com/ddddshka/Prbl/refs/heads/main/signal.lua'))()
